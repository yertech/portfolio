...
const sideDrawer = props => {
  ...
  return (
    ...
    <li><a href="#contact-area">{headerPageData.menucontact}</a></li> */}
        <li>
          <a className="active" onClick={() => props.backdropClickHandler("#")}>
            Home
          </a>
        </li>
        <li>
          <a onClick={() => props.backdropClickHandler("#about-area")}>About</a>
        </li>
        <li>
          <a onClick={() => props.backdropClickHandler("#service-area")}>
            Skills
          </a>
        </li>
        <li>
          <a onClick={() => props.backdropClickHandler("#job-area")}>Jobs</a>
        </li>
        <li>
          <a onClick={() => props.backdropClickHandler("#contact-area")}>
            Contact
          </a>
        </li>
        <li>
          {props.languages.map(lang => {
            return (
              <Link key={lang.slug} className="linkFlag" to={`/${lang.slug}`}>
                <img
                  src={"/img/" + lang.localized_name[props.locale] + ".png"}
                ></img>
              </Link>
            )
          })}
