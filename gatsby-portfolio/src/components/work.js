...
const Work = ({ pageData, serviceData }) => {
  return (
    <section
      className="work-area section-gap-top section-gap-top section-gap-bottom-90"
      id="work-area"
    >
      <div className="container">
        ...
        <div className="filters-content">
          <div className="row grid">
            ...
            <div
              className="single-work col-lg-4 col-md-6 col-sm-12 all branding web-design wow fadeInUp"
              data-wow-duration="2s"
              data-wow-delay="0.4s"
            >
              <div className="relative">
            ...
            <div
              className="single-work col-lg-4 col-md-6 col-sm-12 all web-design wow fadeInUp"
              data-wow-duration="2s"
              data-wow-delay="0.6s"
            >
              <div className="relative">
            ...
            <div
              className="single-work col-lg-4 col-md-6 col-sm-12 all branding wow fadeInUp"
              data-wow-duration="2s"
              data-wow-delay="0.2s"
            >
              <div className="relative">
